...
#SBATCH --output='textfiles/output_normal_%A_%a.log'
#SBATCH --error='textfiles/output_normal_%A_%a.err'
#SBATCH --mem=0
...
python train_critic.py --use_wandb --wandb_run_name normal --save_path /checkpoint/ai_society/jtsu/verl-agent/critic_normal/ --batch_size 32 --store_model_name qv_critic_normal
